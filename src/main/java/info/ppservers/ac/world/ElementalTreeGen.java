...
public class ElementalTreeGen extends WorldGenAbstractTree {
    ...
    public ElementalTreeGen(boolean par1, int mdwood, int mdleaves) {
        super(par1);
        dontFindHeight = par1;
        metaWood = mdwood;
        metaLeaves = mdleaves;
    ...
    void generateLeafNode(int par1, int par2, int par3) {
        ...
        for (int i1 = par2 + this.leafDistanceLimit; l < i1; ++l) {
            ...
            this.func_150529_a(par1, l, par3, f, (byte) 1, BlockHandler.elementalLeaves);
        }
    }
    ...
    void generateTrunk() {
        ...
        this.func_150530_a(aint, aint1, BlockHandler.elementalLog);
    ...
    void generateLeafNodeBases() {
        ...
        for (int[] aint = new int[]{this.basePos[0], this.basePos[1], this.basePos[2]}; i < j; ++i) {
            ...
            if (this.leafNodeNeedsBase(k)) {
                this.func_150530_a(aint, aint2, BlockHandler.elementalLog);
            }
        }
    }
    ...
    int findGround(World world, int x, int y, int z) {
        ...
        do {
            ...
            if (underID == Blocks.dirt || underID == Blocks.grass || height < 64)
                foundGround = true;
        } while (!foundGround);
        return height + 1;
    }
